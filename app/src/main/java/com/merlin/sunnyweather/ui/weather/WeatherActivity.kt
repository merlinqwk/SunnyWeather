...
import com.merlin.sunnyweather.logic.model.getSky
...
class WeatherActivity : AppCompatActivity() {
    ...
    private fun showWeatherInfo(weather: Weather) {
        ...
        var currentSkyCon = getSky(realTime.skycon)
        currentTemp.text = currentTempText
        currentSky.text = currentSkyCon.info
        val currentPM25Text = "空气指数 ${realTime.airQuality.aqi.chn}"
        currentAQI.text = currentPM25Text
        nowLayout.setBackgroundResource(currentSkyCon.bg)
